...
#combine moms and embryos in separate files later by concatenating the files together as you wish. e.g., go to the directory and do:
#cat *raw_cov.txt > combined_raw_cov.txt 
